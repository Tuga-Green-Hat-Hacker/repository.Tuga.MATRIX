...
langSHORTCUT                     = {0: 'www', 1: 'gr', 2: 'fr', 3: 'de', 4: 'it', 5: 'es', 6: 'pt', 7: 'hu', 8: 'ru', 9: 'ua', 10: 'tr', 11: 'arabic', 12: 'per'}[int(addon.getSetting('language'))]
...
#         Webseitenkürzel(euronews) = 0: www|1: gr|2: fr|3: de|4: it|5: es|6: pt|7: hu|8: ru|9: ua|10: tr|11: arabic|12: per
channelLIVE                          = {0: 'sPgqEHsONK8', 1: '-UJlcdni8cM', 2: 'MsN0_WNXvh8', 3: 'gdyuPcnSDuY', 4: 'pnaF6XIU-yQ', 5: 'JbKgQhFlMdU', 6: 'VOw7bts_rGQ', 7: 'xddy7-kDdkE', 8: 'WiB69tJIAU4', 9: '00', 10: '00', 11: '00', 12: '00'}[int(addon.getSetting('language'))]
PlayToYT                                = addon.getSetting('YOUTUBE_LINK') == 'true'
useThumbAsFanart              = addon.getSetting('useThumbAsFanart') == 'true'
enableADJUSTMENT             = addon.getSetting('show_settings') == 'true'
DEB_LEVEL                             = (LOG_MESSAGE if addon.getSetting('enableDebug') == 'true' else xbmc.LOGDEBUG)
BASE_URL                               = 'https://'+langSHORTCUT+'.euronews.com'
